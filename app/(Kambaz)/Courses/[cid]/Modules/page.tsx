export default function Modules() {
    return (
      <div>
        <button>Collapse All</button> <button>View Progress</button> <button>Publish All ▾</button> <button id="wd-add-module">+ Module</button>
        <ul id="wd-modules">
          <li className="wd-module">
            <div className="wd-title">Week 1, Lecture - Course Introduction, syllabus, Agenda</div>
    ...
    <li className="wd-lesson">
      ...
      <ul className="wd-content">
        ...
        <li className="wd-content-item">Formatting content with Lists and Tables</li>
            ...
            <li className="wd-module">
            <div className="wd-title">Week 2, Lecture - Styling User Interfaces with CSS</div>
            <ul className="wd-lessons">
    <li className="wd-lesson">
      <span className="wd-title">LEARNING OBJECTIVES</span>
      <ul className="wd-content">
    ...
    <li className="wd-lesson">
      ...
      <ul className="wd-content">
        <li className="wd-content-item">
          Developing Full Stack Next.js Web Applications - Chapter 3 - Styling Web Pages with CSS
        </li>
        </ul>
        </li>
       </ul>
